...
impl Bogie {
    ...
    pub fn rail_brake_force_newton(self, value: f32) {
        unsafe { lotus_script_sys::vehicle::rail_brake_force_newton(self.index as u32, value) };
    }
}
...
impl Axle {
    ...
    pub fn traction_force_newton(self, value: f32) {
        unsafe {
            lotus_script_sys::vehicle::traction_force_newton(
                self.bogie_index as u32,
                self.axle_index as u32,
                value,
            )
    ...
    pub fn brake_force_newton(self, value: f32) {
        unsafe {
            lotus_script_sys::vehicle::brake_force_newton(
                self.bogie_index as u32,
                self.axle_index as u32,
                value,
            )
